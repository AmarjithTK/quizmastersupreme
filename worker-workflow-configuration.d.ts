/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.workflow.jsonc --env-interface=WorkflowWorkerEnv worker-workflow-configuration.d.ts` (hash: 4fa44ac232d85b5bc38ae6bfdbd5134f)
// Runtime types generated with workerd@1.20260911.1 2026-09-15 nodejs_compat
interface __BaseEnv_WorkflowWorkerEnv {
	STORAGE: R2Bucket;
	DB: D1Database;
	APP_ENV: "production";
	APP_BASE_URL: "";
	DEFAULT_GENERATION_MODEL: "deepseek/deepseek-v4.1-flash";
	EMBEDDING_MODEL: "@cf/baai/bge-m3";
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	SESSION_SECRET: string;
	OPENROUTER_API_KEY: string;
	GENERATION_WORKFLOW: Workflow<Parameters<import("./src/workers/generation-workflow").GenerationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/generation-workflow");
	}
	interface Env extends __BaseEnv_WorkflowWorkerEnv {}
}
interface WorkflowWorkerEnv extends __BaseEnv_WorkflowWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_BASE_URL" | "DEFAULT_GENERATION_MODEL" | "EMBEDDING_MODEL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SESSION_SECRET" | "OPENROUTER_API_KEY">> {}
}
